...
import { AlertTriangle, Hospital, Phone, User, MapPin, Ambulance } from "lucide-react";
		...
		<div className="min-h-[90vh] bg-cyan-50 flex flex-col items-center py-10 px-2 md:px-0">
			<div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
				<div className="flex items-center gap-3 mb-2">
					...
					<h1 className="text-3xl md:text-4xl font-mono font-bold text-cyan-800">Emergency Assistance</h1>
				</div>
				<p className="text-md md:text-lg text-gray-700 font-mono mb-6 text-center">
					Provide details below and we will notify the selected hospital immediately.
				</p>
				...
				<form onSubmit={onSubmit} className="w-full space-y-5">
					...
					<div className="flex items-center gap-2">
						...
						/>
						<label htmlFor="ambulance" className="text-sm font-mono text-cyan-800 flex items-center gap-1">
				...
				<div className="mt-8 w-full">
					<label className="text-sm font-mono font-semibold text-cyan-800 mb-1">Preview message</label>
					<pre className="whitespace-pre-wrap bg-cyan-50 border border-cyan-200 rounded-xl p-4 text-sm font-mono text-cyan-900">{message}</pre>
				</div>
			</div>
		</div>
	);
