...
export default function WhatYouTakingPage() {
	const medicines: MedicineItem[] = (data as any).medicines || [];
								...
								{/* <div className="flex items-center justify-between mt-auto pt-2">
									<span
										className={`text-sm font-bold font-mono ${
											m.stock === "Available" ? "text-green-700" : "text-red-600"
										}`}
									>
										{m.stock}
									</span>
									<button
										className="font-mono text-violet-800 hover:text-violet-600 text-sm font-bold underline transition-all"
										type="button"
									>
										Details
									</button>
